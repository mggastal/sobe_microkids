#!/usr/bin/env python3
"""
Dashboard Microkids — Sobé Estratégias
...
def meta_breakdowns(df):
    ...
    CONV_COLS_BD=["Action Messaging Conversations Started (Onsite Conversion)",
                  "Action Value Messaging Conversations Started (Onsite Conversion)",
                  "Action Leads","Action FB Pixel Custom (Offsite Conversion)"]
    def seg(agg,dim):
